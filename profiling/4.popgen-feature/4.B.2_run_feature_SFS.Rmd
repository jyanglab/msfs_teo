...
# derived SFS
files <- list.files(path="largedata/revise_dmsfs", pattern="csv", full.names=TRUE)
...
write.table(df, "slurm-script/slurm_feature_parameters_dmsfs.csv", sep=",", row.names=FALSE)
