...
snpdt <- fread()
fa <- "/project/jyanglab/jyang21/dbcenter/AGP/AGPv4/Zea_mays.AGPv4.dna.toplevel.fa.gz"
arules <- data.frame(from=c("M", "Y", "R", "K"), to=c("C", "C", "G", "T"))
outdir <- "largedata/pgenome"

h <- read.table("largedata/teo20_VCF_AGPv4/header", header=FALSE)
snpdf <- fread("largedata/teo20_VCF_AGPv4/JRI20_bisnps_annot.txt", header=FALSE)
