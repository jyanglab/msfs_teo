---
title: "Step4: run array job for NA imputation"
...
```{r}
library("huskeR")
run_Rcodes(inputdf=data.frame(file=1:3, out=10), outdir="slurm-script", cmdno = 1, 
           rcodes = "profiling/3.popgen/3.A.4_set_ajob_teo.R",
           arrayshid = "slurm-script/run_rcode_array.sh",
           email="yangjl0930@gmail.com", 
            runinfo = c(FALSE, "jclarke", 10, "30G", "16:00:00"))
