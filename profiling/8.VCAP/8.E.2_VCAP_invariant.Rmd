...
run_batch_vcap(
  input_dir = "data/TEO_LR_invariant_region_DMR_hyper_hypo",
  out_dir="largedata/revise_VCAP/invariant/",
  dmr_patterns = c("CG_TEO_LR", "CHG_TEO_LR") )
...
run_batch_ldak <- function(
  ...
  for(i in 1:length(dmr_patterns)){
    ...
    kinship_dir <- paste0("largedata/revise_VCAP/invariant/", dmr_patterns[i], "/bedfile")
...
run_batch_ldak(dmr_patterns = c("CG_TEO_LR", "CHG_TEO_LR"))
