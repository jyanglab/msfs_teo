...
get_h2(pwd="largedata/revise_VCAP/invariant/CG_TEO_LR/h2", outfile="cache/invariant_vcap/h2_CHG_teo_lr.csv")
...
## Sweep
```{r}
get_h2(pwd="largedata/revise_VCAP/CG-sweep-invariant/h2", outfile="cache/h2-interact-dmr/h2_CG_sweep-invariant.csv")
#get_h2(pwd="largedata/VCAP/CHH_teosinte_maize/h2", outfile="cache/h2_CHH_teosinte_maize.csv")

get_h2(pwd="largedata/revise_VCAP/CHG-sweep-invariant/h2", outfile="cache/h2-interact-dmr/h2_CHG_sweep-invariant.csv")
#get_h2(pwd="largedata/VCAP/CHH_teosinte_maize/h2", outfile="cache/h2_CHH_teosinte_maize.csv")
