...
run_batch_vcap <- function(
  ...
  run_VCAP(df, email = "yangjl0930@gmail.com", jobid = "vcap", runinfo = c(TRUE, "jyanglab", "4", "30G", "48:00:00"))
}

# results will be in largedata/VCAP/CHG_teosinte_maize/bedfile/rest_geno
run_batch_vcap(
  input_dir = "data/TEO_LR_invariant_region_DMR_hyper_hypo_SWEEP_Interaction/CG-Teosinte_Landrace/DMR_interaction_non_interaction",
  out_dir="largedata/revise_VCAP/CG-int-invariant/",
  dmr_patterns = c("CG_TEO_LR") )

# results will be in largedata/VCAP/CHG_teosinte_maize/bedfile/rest_geno
run_batch_vcap(
  input_dir = "data/TEO_LR_invariant_region_DMR_hyper_hypo_SWEEP_Interaction/CHG-Teosinte_Landrace/DMR_interaction_non_interaction",
  out_dir="largedata/revise_VCAP/CHG-int-invariant/",
  dmr_patterns = c("CHG_TEO_LR") )

# results will be in largedata/VCAP/CHG_teosinte_maize/bedfile/rest_geno
run_batch_vcap(
  input_dir = "data/TEO_LR_invariant_region_DMR_hyper_hypo_SWEEP_Interaction/CG-Teosinte_Landrace/DMR_Sweep_non_sweep/",
  out_dir="largedata/revise_VCAP/CG-sweep-invariant/",
  dmr_patterns = c("CG_TEO_LR") )

# results will be in largedata/VCAP/CHG_teosinte_maize/bedfile/rest_geno
run_batch_vcap(
  input_dir = "data/TEO_LR_invariant_region_DMR_hyper_hypo_SWEEP_Interaction/CHG-Teosinte_Landrace/DMR_Sweep_non_sweep",
  out_dir="largedata/revise_VCAP/CHG-sweep-invariant/",
  dmr_patterns = c("CHG_TEO_LR") )
```
...
run_batch_ldak <- function(
  ...
  for(i in 1:length(dmr_patterns)){
    ...
    kinship_dir <- paste0("largedata/revise_VCAP/", dmr_patterns[i], "/bedfile")
  ...
  run_ldak(df, email="yangjl0930@gmail.com", runinfo=c(TRUE, "jyanglab", "2", "10G", "24:00:00"))
}


run_batch_ldak(dmr_patterns = c("CG-int-invariant",  "CHG-int-invariant",  
                                "CG-sweep-invariant", "CHG-sweep-invariant"))
